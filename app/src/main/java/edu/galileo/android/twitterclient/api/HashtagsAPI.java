...
import edu.galileo.android.twitterclient.hashtags.HashtagsEvent;
...
public class HashtagsAPI {
    ...
    private static class SingletonHolder {
        private static final HashtagsAPI INSTANCE = new HashtagsAPI();
    }

    public static HashtagsAPI getInstance() {
